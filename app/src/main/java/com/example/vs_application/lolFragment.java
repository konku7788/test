...
public class lolFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lolFragment.MainAdapter mAdapter;
        ...
        mStore.collection("LOL").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mAdapter = new lolFragment.MainAdapter(mBoardList);
...
//    public View onCreateView(LayoutInflater inflater, ViewGroup container,
//                             Bundle savedInstanceState) {
//        RecyclerView recyclerViewlol;
//        FloatingActionButton addbtnlol;
//        MainAdapter mAdapter;
//        List<board> mBoardList;
//
//        View view = inflater.inflate(R.layout.fragment_lol,container,false);
//        recyclerViewlol = (RecyclerView) view.findViewById(R.id.board_lol_Recycler);
//        view.findViewById(R.id.addbtnlol).setOnClickListener(this);
//
//        mBoardList = new ArrayList<>(); // 10번째
//        mBoardList.add(new board(null,"e스포츠 화면입니다.",null," espt"));
//        mBoardList.add(new board(null,"esports",null," board"));
//        mBoardList.add(new board(null,"롤 화면입니다.",null," lol"));
...
//        recyclerViewlol.setAdapter(mAdapter);
//        // Inflate the layout for this fragment
//        return view;
//    }
