 ...
 * Use the {@link futsalFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class futsalFragment extends Fragment implements View.OnClickListener {
    ...
    public static futsalFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        futsalFragment.MainAdapter mAdapter;
        ...
        mStore.collection("풋살").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mAdapter = new futsalFragment.MainAdapter(mBoardList);
...
//                             Bundle savedInstanceState) {
//
//        RecyclerView recyclerViewfutsal;
//        FloatingActionButton addbtnfutsal;
//        MainAdapter mAdapter;
//        List<board> mBoardList;
//
//        View view = inflater.inflate(R.layout.fragment_futsal,container,false);
//        recyclerViewfutsal = (RecyclerView) view.findViewById(R.id.board_futsal_Recycler);
//        view.findViewById(R.id.addbtnfutsal).setOnClickListener(this);
//
//        mBoardList = new ArrayList<>(); // 10번째
//        mBoardList.add(new board(null,"스포츠 화면입니다.",null," spt"));
//        mBoardList.add(new board(null,"sports",null," board"));
//        mBoardList.add(new board(null,"풋살",null," futsal"));
...
//        recyclerViewfutsal.setAdapter(mAdapter);
//        // Inflate the layout for this fragment
//        return view;
//    }
