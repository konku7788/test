...
public class basketballFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        basketballFragment.MainAdapter mAdapter;
        ...
        mStore.collection("농구").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mAdapter = new basketballFragment.MainAdapter(mBoardList);
...
//    public View onCreateView(LayoutInflater inflater, ViewGroup container,
//                             Bundle savedInstanceState) {
//        RecyclerView recyclerViewbaskerball;
//        FloatingActionButton addbtnsbaskerball;
//        MainAdapter mAdapter;
//        List<board> mBoardList;
//
//        View view = inflater.inflate(R.layout.fragment_basketball,container,false);
//        recyclerViewbaskerball = (RecyclerView) view.findViewById(R.id.board_baskerball_Recycler);
//        view.findViewById(R.id.addbtnbasketball).setOnClickListener(this);
//
//        mBoardList = new ArrayList<>();
//        mBoardList.add(new board(null,"스포츠 화면입니다.",null," spt"));
//        mBoardList.add(new board(null,"sports",null," board"));
//        mBoardList.add(new board(null,"농구",null," baskerball"));
...
//        recyclerViewbaskerball.setAdapter(mAdapter);
//        // Inflate the layout for this fragment
//        return view;
//    }
