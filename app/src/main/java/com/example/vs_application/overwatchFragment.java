 ...
 * Use the {@link overwatchFragment#newInstance} factory method to
...
public class overwatchFragment extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment overwatchFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static overwatchFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        overwatchFragment.MainAdapter mAdapter;
        ...
        mStore.collection("OverWatch").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                mAdapter = new overwatchFragment.MainAdapter(mBoardList);
...
//    public View onCreateView(LayoutInflater inflater, ViewGroup container,
//                             Bundle savedInstanceState) {
//        RecyclerView recyclerViewoverwatch;
//        FloatingActionButton addbtnoverwatch;
//        MainAdapter mAdapter;
//        List<board> mBoardList;
//
//        View view = inflater.inflate(R.layout.fragment_overwatch,container,false);
//        recyclerViewoverwatch = (RecyclerView) view.findViewById(R.id.board_overwatch_Recycler);
//        view.findViewById(R.id.addbtnoverwatch).setOnClickListener(this);
//
//        mBoardList = new ArrayList<>(); // 10번째
//        mBoardList.add(new board(null,"e스포츠 화면 일부입니다.",null," espt"));
//        mBoardList.add(new board(null,"오버워치 화면입니다.",null," board"));
//        mBoardList.add(new board(null,"오버워치",null,"overwatch "));
...
//        recyclerViewoverwatch.setAdapter(mAdapter);
//        // Inflate the layout for this fragment
//        return view;
//    }
